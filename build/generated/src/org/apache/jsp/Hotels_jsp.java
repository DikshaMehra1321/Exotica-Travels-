...
out.println(response.encodeURL("TourPackage.jsp").toString());
      ...
      out.write("</table>\n");
      out.write("<br>\n");
      out.write("<font align='center' color='darkblue' size='+1'>Please select the hotel in which you would like to stay:\n");
...
out.println(response.encodeURL("SessionServlet").toString());
      ...
      out.write("</tr>\n");
      out.write("<tr>\n");
      out.write("<td bordercolor='white'>Number of days: </td>\n");
